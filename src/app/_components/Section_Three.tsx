...
const Section_Three: React.FC = () => {
  return (
    <section className="mt-16 mb-32 2xl:max-w-screen-2xl lg:max-w-screen-lg xl:max-w-screen-xl md:max-w-screen-md 2xl:w-11/12 xl:w-11/12 lg:w-11/12 flex flex-col mx-auto justify-around">
