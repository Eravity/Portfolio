...
const Section_Three: React.FC = () => {
  return (
    <section className="mt-10 mb-12 2xl:max-w-screen-2xl lg:max-w-screen-lg xl:max-w-screen-xl md:max-w-screen-md 2xl:w-11/12 xl:w-11/12 lg:w-11/12 flex flex-col mx-auto justify-around">
      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 lg:scale-[90%] xl:scale-90 gap-5 mx-auto w-full">
        <ProjectFrame
          id={1}
          name="_Project 1"
