...
const Signature: React.FC = (): JSX.Element => {
  return (
    <div className="flex flex-col-reverse lg:flex-col lg:scale-[80%] xl:scale-90 2xl:scale-100">
      <div>
      <h1
        className="text-[80px] lg:text-[100px] xl:text-[120px] font-bold leading-[100px] text-[#99B84A]"
        style={{
          background: "#99B84A",
      ...
      >
        ...
        <h1
          className="text-[60px] lg:text-[70px] font-bold text-[#E43869]"
          style={{
            background: "#E43869",
            WebkitBackgroundClip: "text",
